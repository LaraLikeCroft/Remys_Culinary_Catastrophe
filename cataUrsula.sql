...
DROP TABLE IF EXISTS #cataUrsula
...
WHERE	ISNULL(i1.Sources,'') <> 'fishing' AND
		ISNULL(i2.Sources,'') <> 'fishing' AND
		ISNULL(i3.Sources,'') <> 'fishing' AND
		ISNULL(i4.Sources,'') <> 'fishing' AND
		ISNULL(i5.Sources,'') <> 'fishing'
